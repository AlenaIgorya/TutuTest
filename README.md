...
Функциональные требования к приложению тестировались на устройствах Meizu m2 и Nexus 5. Для выявления структурных проблем в коде использовался статический анализатор Lint.
